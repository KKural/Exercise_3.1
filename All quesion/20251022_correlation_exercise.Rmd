...
save_dodona_image <- function(plot_obj, question_number, filename = NULL, width = 5, height = 3.5) {
  if (is.null(filename)) {
  ...
  if (as.character(question_number) %in% names(question_dirs)) {
    ...
    ggsave(image_path, plot_obj, width = 3, height = 4, dpi = 300, bg = "white")
    cat("Saved image:", image_path, "with dimensions:", width, "x", height, "\n")
  }
}
...
save_dodona_image(p_q3, 3, width = 2, height = 2)
```
