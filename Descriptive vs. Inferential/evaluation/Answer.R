    ...
    " ",
    {
      testEqual(
        ...
        comparator = function(generated, expected, ...) {
          feedbacks <- list(
            # ❌ Fout. This refers to inferential or predictive statistics, not descriptive statistics.
            ...
            # ❌ Fout. Hypothesis testing is part of inferential statistics, not descriptive.
            "3" = "❌ Fout. Het toetsen van hypotheses hoort bij inferentiële statistiek, niet bij beschrijvende statistiek.",
            
            # ❌ Fout. Causal modeling involves complex statistical inference, not mere description.
        ...
        # Hide the expected value in the report
        show_expected = FALSE
      )
    }
  )
