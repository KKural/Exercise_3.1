      ...
      testEqual(
        ...
        comparator = function(generated, expected, ...) {
          feedbacks <- list(
            ...
            "3" = "❌ Niet juist. Een perfecte correlatie zou een R² van 1 opleveren, niet 0,33.",
            
            # ✅ Correct! R² = 0,33 means 33% of the variance in violent crime is explained by unemployment differences.
            "4" = "✅ Correct! Een R² van 0,33 betekent dat 33% van de variantie in gewelddadige misdrijven tussen wijken verklaard wordt door verschillen in werkloosheid."
          )
