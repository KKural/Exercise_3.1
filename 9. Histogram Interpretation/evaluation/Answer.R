      ...
      testEqual(
        ...
        comparator = function(generated, expected, ...) {
          feedbacks <- list(
            ...
            # ❌ Incorrect. A symmetric distribution would show a bell shape around the mean, which this does not.
            "3" = "❌ Fout. Een symmetrische verdeling zou een klokvorm rond het gemiddelde tonen, maar dat zien we hier niet.",
            
            # ❌ Incorrect. Bimodal distributions have two clear peaks, which are not present in this histogram.
