      ...
      testEqual(
        ...
        comparator = function(generated, expected, ...) {
          feedbacks <- list(
            ...
            "1" = "❌ Nee. De box voor ‘Inbraak’ ligt juist het hoogst, dus de mediaan is het hoogste, niet het laagste.",
            ...
            "3" = "✅ Correct! ‘Inbraak’ heeft de hoogste mediaan én enkele uitschieters boven de bovenste whisker.",
            
            # ❌ Not correct. Mishandeling does show a box and whiskers, meaning there is variation.
            "4" = "❌ Niet juist. ‘Mishandeling’ toont wel degelijk spreiding; het heeft een box en whiskers in de plot."
          )
