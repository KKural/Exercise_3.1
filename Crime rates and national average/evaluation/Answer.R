      ...
      testEqual(
        ...
        comparator = function(generated, expected, ...) {
          feedbacks <- list(
            ...
            "1" = "✅ Correct! District X heeft een cijfer van 85, wat duidelijk boven het nationale gemiddelde van 50 ligt en dus een uitschieter is.",
            ...
            "3" = "❌ Nee. District Z ligt iets onder het gemiddelde, maar is geen opvallende afwijking.",
            
            # ❌ Not correct. District W is exactly at the national average of 50.
            "4" = "❌ Niet juist. District W zit exact op het nationale gemiddelde en is dus geen uitschieter."
          )
