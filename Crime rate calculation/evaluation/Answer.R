      ...
      testEqual(
        ...
        comparator = function(generated, expected, ...) {
          feedbacks <- list(
            ...
            "1" = "✅ Correct! (1.200 / 300.000) × 1.000 = 4,0 inbraken per 1.000 inwoners.",
            ...
            "3" = "❌ Nee. Dat zou kloppen als er 1.050 inbraken waren, maar er waren 1.200.",
            
            # ❌ Not correct. 5,0 would imply 1.500 burglaries for 300.000 people.
            "4" = "❌ Niet juist. Een cijfer van 5,0 zou betekenen dat er 1.500 inbraken waren, niet 1.200."
          )
